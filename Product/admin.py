...
class OrderAdmin(admin.ModelAdmin):
    list_display = ['product_1', 'count_1', 'product_2', 'count_2', 'product_3', 'count_3', 'cost', 'order_by', 'name',
                    'address', 'postcode', 'city', 'delivered', 'delivered_on', 'created', 'last_updated', 'information', 'payment_method']
