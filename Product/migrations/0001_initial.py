...
class Order(models.Model):
    ...
    product_1 = models.ForeignKey(Product, on_delete=models.CASCADE, related_name="Order.product_1+", null=True, blank=True)
    count_2 = models.IntegerField(default=0)
    product_2 = models.ForeignKey(Product, on_delete=models.CASCADE, related_name="Order.product_2+", null=True, blank=True)
    count_3 = models.IntegerField(default=0)
    product_3 = models.ForeignKey(Product, on_delete=models.CASCADE, related_name="Order.product_3+", null=True, blank=True)
